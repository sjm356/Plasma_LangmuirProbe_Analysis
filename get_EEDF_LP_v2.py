...
v2.0: Changing the method to get the plasma potential. the cross point of two linear fitting is determined with Plasma Potential
...
v3.0: Connecting EEPF data between SG data and BW data at similar data point. low energy -> SG, high energy -> BW
